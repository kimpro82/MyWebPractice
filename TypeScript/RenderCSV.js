...
var CSV_FILE_NAME = 'Dinosaurs.csv';
var TABLE_ELEMENT_ID = 'dino-table';
/**
...
function loadCSV() {
    return __awaiter(this, void 0, void 0, function () {
        var response, csvText, result, _a, headers, rows, table, thead, headerRow, tbody;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, fetch(CSV_FILE_NAME)];
                case 1:
                    response = _b.sent();
                    return [4 /*yield*/, response.text()];
                case 2:
                    csvText = _b.sent();
                    result = Papa.parse(csvText, { skipEmptyLines: true });
                    _a = result.data, headers = _a[0], rows = _a.slice(1);
                    table = document.getElementById(TABLE_ELEMENT_ID);
